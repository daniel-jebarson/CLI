...
//     await page.goto(`https://www.google.com/search?q=${String(searchQuery).split(" ").join("%20")}`);
//     await page.goto(`https://en.wikipedia.org/w/api.php?action=query&list=search&srsearch=${searchQuery}&format=json`)
//     await page.$eval(``);
// }
const about = async searchQuery =>
...
figlet.text('Danie-Cyber', 'Slant', (err, res) => {
    if (err) {
